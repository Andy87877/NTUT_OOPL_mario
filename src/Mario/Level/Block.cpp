...
bool Block::ShouldResolveVerticallyFirst(const AABB& /*playerBody*/) const {
    return false;
}

void Block::TryCarryPlayer(PlayerState& /*ps*/, const AABB& /*prevAABB*/,
                           bool /*onStaticBlock*/) {
    // Default implementation does nothing (standard blocks don't carry the player)
}
